...
if (IRODS_BUILD_AGAINST_LIBCXX)
  ...
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    find_library(LIBM_LIBRARY NAMES m amdlibm)
    ...
    if (LIBM_LIBRARY)
      set(CMAKE_CXX_STANDARD_LIBRARIES "${LIBM_LIBRARY} ${CMAKE_CXX_STANDARD_LIBRARIES}")
    else()
      set(CMAKE_CXX_STANDARD_LIBRARIES "-lm ${CMAKE_CXX_STANDARD_LIBRARIES}")
    endif()
    if (LIBC_LIBRARY)
