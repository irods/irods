...
miss_msvc=$(grep "load_microservice_plugin :: failed to load microservice plugin: /usr/share/eirods/iRODS/server/bin//libmissing_micro_service.so" /usr/share/eirods/iRODS/server/log/rodsLog* )
