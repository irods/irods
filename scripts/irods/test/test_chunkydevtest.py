...
class ChunkyDevTest(ResourceBase):
    ...
    def test_beginning_from_devtest(self):
        ...
        # overwrite a copy
        self.admin.assert_icommand("itrim -S " + irodsdefresource + " -N1 " + irodshome + "/icmdtest/foo1", 'STDOUT', "data objects trimmed")
    ...
    def test_iput_ibun_gzip_bzip2_from_devtest(self):
        ...
        self.admin.assert_icommand("itrim -S " + irodsdefresource + " " + irodshome + "/icmdtest/foo1", 'STDOUT', "data objects trimmed")
        # bulk test
