...
/**
 * \fn int rs_atomic_apply_metadata_operations(rsComm_t* _comm, const char* _json_input, char* _json_output)
 *
 ...
 **/
int rs_atomic_apply_metadata_operations(rsComm_t* _comm, const char* _json_input, char** _json_output);
