...
inline const packInstruct_t api_pack_table_init[] = {
    ...
    {"getLogicalQuotaInp_PI", getLogicalQuotaInp_PI, irods::clearInStruct_noop},
    {"logicalQuota_PI", logicalQuota_PI, irods::clearInStruct_noop},
    {"logicalQuotaList_PI", logicalQuotaList_PI, irods::clearInStruct_noop},
