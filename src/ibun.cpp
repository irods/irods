...
usage() {
    char *msgs[] = {
        ...
        "Also note the use of the -h option with the tar command. This instructs ",
        "tar to follow all symlinks. This means that the structured files fed to ",
        "ibun should NOT contain symbolic links as they are not supported by ibun.",
        ...
        "will continue.",
        " ",
        "If the -x and -R option are used together, the source structFile must",
        "already have a replica on the named resource.",
        " ",
