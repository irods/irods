...
NEW_ERROR(INVALID_INPUT_ARGUMENT_NULL_POINTER,         -184000)
NEW_ERROR(CONNECTION_REFUSED,                          -185000)
NEW_ERROR(LOGICAL_QUOTA_EXCEEDED,                      -186000)
NEW_ERROR(NARROWING_CONVERSION_ERROR,                  -187000)
...
NEW_ERROR(REPLICA_STAGING_FAILED,                      -722000)
...
NEW_ERROR(BACKUPRESCNAME_EMPTY_IN_STRUCT_ERR,          -1025000) // EOL since iRODS v5.0.0
...
NEW_ERROR(DIGEST_INIT_FAILED,                   -1831000)
