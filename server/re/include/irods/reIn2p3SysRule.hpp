...
[[deprecated]] int msiDigestMonStat(msParam_t* cpu_wght,
                                    msParam_t* mem_wght,
                                    msParam_t* swap_wght,
                                    msParam_t* runq_wght,
                                    msParam_t* disk_wght,
...
[[deprecated]] int msiFlushMonStat(msParam_t* timespan, msParam_t* tablename, ruleExecInfo_t* rei);

[[deprecated]] int msiServerMonPerf(msParam_t* verbosity, msParam_t* probtime, ruleExecInfo_t* rei);
