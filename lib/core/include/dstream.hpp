...
namespace io {
    ...
    public:
        ...
        static_assert(std::is_same<char_type, char>::value, R"(character type must be "char")");
    ...
    private:
        ...
        // Errors
        static constexpr auto external_write_error          = -1;
    ...
    const typename basic_data_object_buf<CharT, Traits>::pos_type
        basic_data_object_buf<CharT, Traits>::seek_error = basic_data_object_buf<CharT, Traits>::off_type{-1};
