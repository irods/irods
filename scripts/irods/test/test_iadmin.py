...
class test_moduser_user(unittest.TestCase):
    ...
    def moduser_to_rodsgroup_is_not_allowed_test_impl(self, target_username, user_type):
        ...
        self.admin.assert_icommand(
            ["iadmin", "moduser", target_username, 'type', "rodsgroup"], 'STDERR', 'SYS_NOT_ALLOWED')
        self.assertEqual(user_type, lib.get_user_type(self.admin, target_username))

    def test_moduser_type_rodsuser_rodsgroup(self):
    ...
    def test_moduser_type_rodsadmin_rodsgroup(self):
    ...
    def test_moduser_type_groupadmin_rodsgroup(self):
...
class test_moduser_group(unittest.TestCase):
    ...
    def moduser_type_on_rodsgroup_is_not_allowed_test_impl(self, new_type):
        ...
        self.admin.assert_icommand(
            ['iadmin', 'moduser', self.group, 'type', new_type], 'STDERR', 'SYS_NOT_ALLOWED')
        self.assertEqual('rodsgroup', lib.get_user_type(self.admin, self.group))

    def test_moduser_type_invalid_user_type_is_not_allowed(self):
        self.moduser_type_on_rodsgroup_is_not_allowed_test_impl("invalid_user_type")

    def test_moduser_type_rodsadmin_is_not_allowed(self):
        self.moduser_type_on_rodsgroup_is_not_allowed_test_impl("rodsadmin")

    def test_moduser_type_rodsuser_is_not_allowed(self):
        self.moduser_type_on_rodsgroup_is_not_allowed_test_impl("rodsuser")

    def test_moduser_type_rodsgroup_is_not_allowed(self):
    ...
    def test_moduser_zone_for_rodsgroup_is_not_allowed(self):
        """Test modifying the user's zone (not allowed)."""
        self.assertEqual(self.admin.zone_name, lib.get_user_zone(self.admin, self.group))
        self.admin.assert_icommand(['iadmin', 'moduser', self.group, 'zone', 'nopes'], 'STDERR', 'SYS_NOT_ALLOWED')
        self.assertEqual(self.admin.zone_name, lib.get_user_zone(self.admin, self.group))

    def test_moduser_comment_for_rodsgroup_is_not_allowed(self):
        """Test modifying the group's comment field (not allowed)."""
        comment = 'this is a comment'
        self.assertEqual('', lib.get_user_comment(self.admin, self.group))
        self.admin.assert_icommand(['iadmin', 'moduser', self.group, 'comment', comment], 'STDERR', 'SYS_NOT_ALLOWED')
        self.assertEqual('', lib.get_user_comment(self.admin, self.group))

    def test_moduser_info_for_rodsgroup_is_not_allowed(self):
        """Test modifying the group's info field (not allowed)."""
        info = 'this is the info field'
        self.assertEqual('', lib.get_user_info(self.admin, self.group))
        self.admin.assert_icommand(['iadmin', 'moduser', self.group, 'info', info], 'STDERR', 'SYS_NOT_ALLOWED')
        self.assertEqual('', lib.get_user_info(self.admin, self.group))

    def test_moduser_password_for_rodsgroup_is_not_allowed(self):
        ...
        self.admin.assert_icommand(['iadmin', 'moduser', self.group, 'password', pw], 'STDERR', 'SYS_NOT_ALLOWED')
