...
cd $1
ln -s ./clients/icommands/bin/chgCoreToCore1.ir    /usr/bin/chgCoreToCore1.ir
ln -s ./clients/icommands/bin/chgCoreToCore2.ir    /usr/bin/chgCoreToCore2.ir
ln -s ./clients/icommands/bin/chgCoreToOrig.ir     /usr/bin/chgCoreToOrig.ir
ln -s ./clients/icommands/bin/delUnusedAVUs.ir     /usr/bin/delUnusedAVUs.ir
...
ln -s ./clients/icommands/bin/runQuota.ir          /usr/bin/runQuota.ir
ln -s ./clients/icommands/bin/runQuota.r           /usr/bin/runQuota.r
ln -s ./clients/icommands/bin/showCore.ir          /usr/bin/showCore.ir
