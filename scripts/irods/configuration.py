...
class IrodsConfig(object):
    ...
    def get_admin_password(self, check_legacy_password_file=False):
        ...
        Args:
            check_legacy_password_file: If True, get the password out of the .irodsA file. Else, read the cached value.
    ...
    def set_admin_password(self, value, create_legacy_password_file=False):
        ...
        Args:
            create_legacy_password_file: If True, write the password to the .irodsA file. Else, only write cached value.
        """
