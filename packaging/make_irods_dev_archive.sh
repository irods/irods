...
g++ -fPIC -shared -rdynamic "-Wl,${SO_OPTION},${CLIENT_API_SONAME}${LD_ADD}" -o ${CLIENT_API_REAL_NAME} $(find iRODS/lib/client_exec -name *.o) $(find iRODS/lib -name irods_*_object.o) $(find iRODS/lib -name irods_*_manager.o) $(find iRODS/lib -name irods_*_plugin.o)
