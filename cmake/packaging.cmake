...
string(TOUPPER ${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME} IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE)
...
# proper libxml2 package for ubuntu
if (IRODS_LINUX_DISTRIBUTION_NAME STREQUAL "ubuntu" AND IRODS_LINUX_DISTRIBUTION_VERSION_MAJOR GREATER_EQUAL 26)
  set(CPACK_DEBIAN_PACKAGE_DEPENDS_LIBXML "libxml2-16")
else()
  set(CPACK_DEBIAN_PACKAGE_DEPENDS_LIBXML "libxml2")
endif()
...
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME_UPPERCASE}_PACKAGE_DEPENDS "${IRODS_PACKAGE_DEPENDENCIES_STRING}, libc6, sudo, libfuse2, openssl, ${CPACK_DEBIAN_PACKAGE_DEPENDS_LIBXML}, ${CPACK_DEBIAN_PACKAGE_DEPENDS_CURL}, libfmt${fmt_VERSION_MAJOR}, ${CPACK_DEBIAN_PACKAGE_DEPENDS_SPDLOG}, libgcc-s1, libstdc++6")
...
## iCommands package
#######################################
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_NAME "irods-icommands")
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_DEPENDS "irods-runtime (= ${IRODS_VERSION}), libc6")
if (OPENSSL_VERSION VERSION_LESS "3.0.0")
  set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_DEPENDS "${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_DEPENDS}, libssl1.1")
else()
  set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_DEPENDS "${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_DEPENDS}, libssl3")
endif()
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_PROVIDES "irods-icommands (= ${IRODS_VERSION})")
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_REPLACES "irods-icat, irods-resource")
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_CONFLICTS "irods-experimental-api-plugin-genquery2")
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_CONTROL_EXTRA "${CMAKE_IRODS_SOURCE_DIR}/clients/icommands/packaging/postinst;")

set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_NAME "irods-icommands")
set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_REQUIRES "irods-runtime = ${IRODS_VERSION}, openssl")
set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_OBSOLETES "irods-icat, irods-resource")
set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_CONFLICTS "irods-experimental-api-plugin-genquery2")
set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_POST_INSTALL_SCRIPT_FILE "${CMAKE_IRODS_SOURCE_DIR}/clients/icommands/packaging/postinst")

if (CPACK_GENERATOR STREQUAL "DEB")
  install(
    FILES
    "${CMAKE_IRODS_SOURCE_DIR}/LICENSE"
    DESTINATION "${CMAKE_INSTALL_DOCDIR}/${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_ICOMMANDS_NAME_UPPERCASE}_PACKAGE_NAME}"
...
if (IRODS_LINUX_DISTRIBUTION_VERSION_MAJOR EQUAL 7)
  ...
  set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_SERVER_NAME}_PACKAGE_REQUIRES "${CPACK_RPM_${IRODS_PACKAGE_COMPONENT_SERVER_NAME}_PACKAGE_REQUIRES}, python3-jsonschema, python3-distro, python3-pyodbc, python3-cryptography")
endif()
