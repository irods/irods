...
/* BEGIN generated code */
   int irodsErrors[]={ 
    ...
    SYS_FS_LOCK_ERR,                   // JMC - backport 4598
    SYS_LOCK_TYPE_INP_ERR,             // JMC - backport 4599
    SYS_LOCK_CMD_INP_ERR,              // JMC - backport 4599
	SYS_ZIP_FORMAT_NOT_SUPPORTED,      // JMC - backport 4635
	SYS_ADD_TO_ARCH_OPR_NOT_SUPPORTED, // JMC - backport 4643
    CANT_REG_IN_VAULT_FILE,  // JMC - backport 4774
    PATH_REG_NOT_ALLOWED,    // JMC - backport 4774
    SYS_INVALID_INPUT_PARAM, // JMC - backport 4774
	...
	SYMLINKED_BUNFILE_NOT_ALLOWED, // JMC - backport 4833
	...
	CAT_PSEUDO_RESC_MODIFY_DISALLOWED, // JMC - backport 4629
	CAT_BIND_VARIABLE_LIMIT_EXCEEDED,  // JMC - backport 4848
    RDA_NOT_COMPILED_IN, 
    RDA_NOT_CONNECTED, 
    RDA_ENV_ERR, 
    RDA_CONNECT_ERR, 
