...
#include "irods/private/irods_replicator.hpp"
...
irods::error repl_file_rebalance(
    ...
    try {
        ...
        auto has_bad_repl = irods::update_out_of_date_replicas(_ctx, leaf_bundles, batch_size, invocation_timestamp, resource_name);
        auto has_missing_repls = irods::create_missing_replicas(_ctx, leaf_bundles, batch_size, invocation_timestamp, resource_name);
