...
TEST_CASE_METHOD(test_fixture_for_issue_8993,
                 "rcObjStat on data object with only good replicas returns object status held by either good replica")
{
...
TEST_CASE_METHOD(
    test_fixture_for_issue_8993,
    "rcObjStat on data object with mixed stale and good replicas returns object status held by good replica")
{
...
TEST_CASE_METHOD(test_fixture_for_issue_8993,
                 "rcObjStat on data object with only stale replicas returns status held by first replica")
{
...
TEST_CASE_METHOD(
    test_fixture_for_issue_8993,
    "rcObjStat on data object with mixed good and invalid replicas returns object status from good replica")
{
    constexpr rodsLong_t bad_size{10};
...
TEST_CASE_METHOD(test_fixture_for_issue_8993,
                 "rcObjStat on data object with only invalid replicas returns status held by first replica")
{
    constexpr rodsLong_t bad_size_one{10};
