...
/* BEGIN generated code */
   int irodsErrors[]={ 
    ...
    EIRODS_FILE_NOT_IN_VAULT, 
    EIRODS_DIRECT_ARCHIVE_ACCESS, 
    EIRODS_ADVANCED_NEGOTIATION_NOT_SUPPORTED, 
    EIRODS_DIRECT_CHILD_ACCESS, 
    EIRODS_INVALID_DYNAMIC_CAST, 
    NETCDF_OPEN_ERR, 
    NETCDF_CREATE_ERR, 
    NETCDF_CLOSE_ERR, 
