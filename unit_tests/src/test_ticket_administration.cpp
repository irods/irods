...
TEST_CASE("ticket administration")
{
    ...
    SECTION("create read ticket / delete ticket")
    {
        ...
        general_query = builder.build<rcComm_t>(conn, fmt::format("select TICKET_STRING where TICKET_STRING = '{}'", read_ticket_name));
    ...
    SECTION("create write ticket/admin delete ticket")
    {
        ...
        general_query = builder.build<rcComm_t>(conn, fmt::format("select TICKET_STRING where TICKET_STRING = '{}'", write_ticket_name));
