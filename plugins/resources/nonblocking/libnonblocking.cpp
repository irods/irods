...
extern "C" {
    ...
    } // non_blocking_file_get_fsfreespace_plugin
    ...
    } // non_blocking_file_create_plugin
    ...
    } // non_blocking_file_write_plugin
    ...
    } // non_blocking_file_close_plugin
    ...
    } // non_blocking_file_unlink_plugin
    ...
    } // non_blocking_file_lseek_plugin
    ...
    } // non_blocking_file_mkdir_plugin
    ...
    } // non_blocking_file_rmdir_plugin
    ...
    } // non_blocking_file_opendir_plugin
    ...
    } // non_blocking_file_closedir_plugin
    ...
    } // non_blocking_file_readdir_plugin
        ...
        const char*                         _new_file_name )
    {
        ...
        if((result = ASSERT_PASS(ret, "Invalid parameters or physical path.")).ok()) {
            ...
            if((result = ASSERT_PASS(ret, "Unable to generate full path for destination file: \"%s\".",
                ...
                ret = non_blocking_file_mkdir_r( _ctx.comm(), "", new_path.c_str(), 0750 );
                ...
                if( status < 0 ) {
                    ...
                    std::stringstream msg;
                    msg << "non_blocking_file_rename_plugin: rename error for ";
    ...
    } // non_blocking_file_rename_plugin
    ...
    eirods::error non_blocking_file_truncate_plugin( 
        ...
        if( status < 0 ) {
            ...
            std::stringstream msg;
            msg << "non_blocking_file_truncate_plugin: rename error for ";
        ...
        const char*                      _cache_file_name )
    {
        ...
        return result;
    } // non_blocking_file_stagetocache_plugin
    ...
    } // non_blocking_file_synctoarch_plugin
...
rodsLog( LOG_NOTICE, "XXXX - non_blocking_file_redirect_open :: obj [%s], hier [%s], repl_requested [%d]", _file_obj->logical_path().c_str(), _file_obj->resc_hier().c_str(), _file_obj->repl_requested() );
                    // =-=-=-=-=-=-=-
...
rodsLog( LOG_NOTICE, "XXXX - non_blocking_file_redirect_open :: resc_name [%s], last_resc [%s], repl_num [%d]", _resc_name.c_str(), last_resc.c_str(), itr->repl_num() );
...
rodsLog( LOG_NOTICE, "XXXX - non_blocking_file_redirect_open :: resc_us - vote %f", _out_vote );
    ...
    } // non_blocking_file_redirect_plugin
