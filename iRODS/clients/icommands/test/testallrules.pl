...
runCmd( "iadmin mkresc testallrulesResc 'unix file system' cache localhost:/tmp/$unixuser/testallrulesResc I_AM_ALSO_A_CONTEXT_STRING", "", "", "", "iadmin rmresc testallrulesResc" );
