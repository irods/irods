...
int
getNextNode( tdsDirStruct_t *tdsDirStruct ) {
    if ( tdsDirStruct == NULL || tdsDirStruct->curnode == NULL ) {
        return False;
    }
...
int
freeTdsDirStruct( tdsDirStruct_t **tdsDirStruct ) {
    if ( tdsDirStruct == NULL || *tdsDirStruct == NULL ) {
        return 0;
    }
