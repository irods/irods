...
// The SimpleQuery API has been removed. Use GenQuery or SpecificQuery instead.
...
API_NUMBER(GET_LOGICAL_QUOTA_AN,                    803)
...
API_NUMBER(UPDATE_REPLICA_ACCESS_TIME_AN,           10224)
