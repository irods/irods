...
auto rc_server_unit_test(RcComm* _comm, const char* _json_input, char** _json_output) -> int
{
    ...
    const int ec = procApiRequest(_comm, UNIT_TEST_APN,
                                  &input_buf, nullptr,
