...
auto rc_atomic_apply_acl_operations(RcComm* _comm, const char* _json_input, char** _json_output) -> int
{
    ...
    const int ec = procApiRequest(_comm, ATOMIC_APPLY_ACL_OPERATIONS_APN,
                                  &input_buf, nullptr,
