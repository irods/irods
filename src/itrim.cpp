...
usage() {
    char* msgs[] = {
        "Usage: itrim [-hMrvV] [--dryrun] [-n replNum]|[-S srcResource] [-N numReplicas] dataObj|collection ... ",
        " ",
        ...
        " ",
        "It is recommended that this iCommand be used as a precision tool for managing",
        "individual replicas. First, determine the replica number of the replica to",
        "delete, then target that replica for deletion. Here is the usage:",
        " ",
        "    itrim -n 2 /tempZone/home/alice/foo",
        " ",
        ...
        " -N  numReplicas - minimum number of replicas to keep. The default value is 2.",
