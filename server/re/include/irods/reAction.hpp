...
///
/// \since 5.1.0
int msi_calculate_logical_usage(ruleExecInfo_t* _rei);
...
namespace irods
{
    ...
    lookup_table< irods::ms_table_entry* >::lookup_table() {
        ...
        table_[ "msi_calculate_logical_usage" ] = new irods::ms_table_entry( "msi_calculate_logical_usage", 0, std::function<int(ruleExecInfo_t*)>( msi_calculate_logical_usage ) );
...
#pragma GCC diagnostic pop
        ...
        table_[ "msi_set_logical_quota" ] = new irods::ms_table_entry( "msi_set_logical_quota", 3, std::function<int(msParam_t*,msParam_t*,msParam_t*,ruleExecInfo_t*)>(msi_set_logical_quota ) );
