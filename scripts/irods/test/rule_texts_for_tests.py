...
def pep_api_hello_world_pre(rule_args, callback):
    callback.writeLine('serverLog', 'pep_api_hello_world_pre - {0} {1} {2}, {3}'.format(rule_args[0], rule_args[1], rule_args[2], rule_args[3]))

def pep_api_hello_world_post(rule_args, callback):
    callback.writeLine('serverLog', 'pep_api_hello_world_post - {0} {1} {2}, {3}'.format(rule_args[0], rule_args[1], rule_args[2], rule_args[3]))
'''
...
#OUTPUT ruleExecOut
#'''
#rule_texts['irods_rule_engine_plugin-python-instance']['Test_Rulebase']['test_irods_re_infinite_recursion_3169'] = '''
#call_with_wrong_number_of_string_arguments(*A, *B, *C) {
#}
#
#acPostProcForPut {
