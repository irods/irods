...
int call_get_resource_info_for_operation(irods::api_entry* _api, rsComm_t* _comm, dataObjInp_t* _inp, char** _out)
{
...
int call_update_replica_access_time_inout(irods::api_entry* _api, rsComm_t* _comm, BytesBuf* _inp, char** _out)
{
    return _api->call_handler<BytesBuf*, char**>(_comm, _inp, _out);
} // call_update_replica_access_time_inout
