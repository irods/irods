 ...
 */
    ...
    public:
        ...
        const file_object& object(void) const { return file_object_; }
        const std::string& operation(void) const { return operation_; }

        file_object& object(void) { return file_object_; }
        std::string& operation(void) { return operation_; }
