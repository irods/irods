...
namespace filesystem {
    ...
    public:
        ...
        explicit object_status(object_type _type, const std::vector<entity_permission>& _perms = {}) noexcept
            : type_{_type}
            , perms_{_perms}
        {
        }
        ...
        auto permissions(const std::vector<entity_permission>& _perms) noexcept -> void { perms_ = _perms; }
