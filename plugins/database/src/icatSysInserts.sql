/* 
As initialized by via this file, all objects, including tokens, have a
unique ID.  Each type has its own range of values.  The IDs inserted
via this file have values less than 10,000 and IDs generated by the
code, via the sql 'sequence R_ObjectId', start at 10,000.
