...
def run_update(irods_config, cursor, is_upgrade):
    ...
    if new_schema_version == 2:
        ...
        if irods_config.catalog_database_type == 'mysql':
            ...
            try:
                database_connect.execute_sql_file(sql_file, cursor, by_line=True)
    ...
    elif new_schema_version == 13:
        # password hashing parameters
        default_password_hashing_parameters = {
            "algorithm": "scrypt",
            "parameters": {
                "N": 16384,
                "r": 8,
        ...
        database_connect.execute_sql_statement(cursor, "insert into R_GRID_CONFIGURATION values ('logical_quotas', 'enforcement_enabled', '0');")
    else:
