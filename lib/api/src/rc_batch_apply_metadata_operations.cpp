...
extern "C"
auto rc_batch_apply_metadata_operations(rcComm_t* _comm, const char* _json_input, char** _json_output) -> int
{
    ...
    const int ec = procApiRequest(_comm, BATCH_APPLY_METADATA_OPERATIONS_APN,
                                  &input_buf, nullptr,
