...
if [ "$PYTESTS" != "" ] ; then
    ...
    $PYTHONCMD $OPTS test_resource_types iadmin_suite catalog_suite test_workflow_suite test_mso_suite test_resource_tree test_load_balancer_suite test_xmsg
