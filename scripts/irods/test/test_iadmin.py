...
class test_moduser_remove_password(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        # Configure a specific query to get the test user's irods password. NOTE: DO NOT DO THIS IN PRODUCTION!!!1
