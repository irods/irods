...
class Test_Compound_with_MockArchive_Resource(unittest.TestCase, ResourceSuite, ChunkyDevTest):
    ...
    my_test_resource = {
        "setup"    : [
            ...
            "iadmin mkresc archiveResc mockarchive "+hostname+":/var/lib/irods/archiveRescVault univMSSInterface.sh",
...
class Test_Compound_with_UniversalMSS_Resource(unittest.TestCase, ResourceSuite, ChunkyDevTest):
    ...
    my_test_resource = {
        "setup"    : [
            ...
            "iadmin mkresc demoResc compound",
            "iadmin mkresc cacheResc 'unix file system' "+hostname+":/var/lib/irods/cacheRescVault",
            "iadmin mkresc archiveResc univmss "+hostname+":/var/lib/irods/archiveRescVault univMSSInterface.sh",
            "iadmin addchildtoresc demoResc cacheResc cache",
            "iadmin addchildtoresc demoResc archiveResc archive",
        ],
        "teardown" : [
...
class Test_Compound_Resource(unittest.TestCase, ResourceSuite, ChunkyDevTest):
    ...
    my_test_resource = {
        "setup"    : [
            ...
            "iadmin mkresc demoResc compound",
            "iadmin mkresc cacheResc 'unix file system' "+hostname+":/var/lib/irods/cacheRescVault",
            "iadmin mkresc archiveResc 'unix file system' "+hostname+":/var/lib/irods/archiveRescVault",
            "iadmin addchildtoresc demoResc cacheResc cache",
            "iadmin addchildtoresc demoResc archiveResc archive",
        ],
        "teardown" : [
...
class Test_Replication_within_Replication_Resource(unittest.TestCase, ResourceSuite, ChunkyDevTest):
    ...
    my_test_resource = {
        "setup"    : [
            ...
            "iadmin mkresc unixA 'unix file system' "+hostname+":/var/lib/irods/unixAVault",
            "iadmin mkresc unixB1 'unix file system' "+hostname+":/var/lib/irods/unixB1Vault",
            "iadmin mkresc unixB2 'unix file system' "+hostname+":/var/lib/irods/unixB2Vault",
...
class Test_Replication_to_two_Compound_Resources(unittest.TestCase, ResourceSuite, ChunkyDevTest):
    ...
    my_test_resource = {
        "setup"    : [
            ...
            "iadmin mkresc cacheResc1 'unix file system' "+hostname+":/var/lib/irods/cacheResc1Vault",
            "iadmin mkresc archiveResc1 'unix file system' "+hostname+":/var/lib/irods/archiveResc1Vault",
            "iadmin mkresc cacheResc2 'unix file system' "+hostname+":/var/lib/irods/cacheResc2Vault",
            "iadmin mkresc archiveResc2 'unix file system' "+hostname+":/var/lib/irods/archiveResc2Vault",
