...
usage() {
    char *msgs[] = {
        ...
        "       must be specified.  Multiple input values can be passed by separating",
        "       them using a %.  For example:",
        " ",
        "           irule ... '*x=100%*y=\"/tempZone/home/public\"%*z=string containing spaces' ...",
        " ",
        "       Notice that *z is an unquoted string containing whitespace.  This only",
        "       works because the input values are wrapped in single quotes.  All values",
        "       will be passed as strings.",
        ...
        "    - The inputFile must be smaller than 1024*20 characters.",
        ...
        " ",
        "The inputFile should contain 3 parts:",
        "    1) rule definition: defined by name and curly braces ({}) block.",
        "    2) INPUT line: specifies input arguments as %-separated label=value pairs.",
        "        - Use %% to specify a literal % in an input value.",
        ...
        "        - The input arguments can be just 'null'.",
        "    3) OUTPUT line: specifies output arguments %-separated labels.",
        "        - The built-in variable ruleExecOut stores output from the rule",
        "             generated by microservices.",
        "        - The output arguments can be just 'null'.",
        " ",
        ...
        "    https://github.com/irods/irods_client_icommands/tree/main/test/rules",
        " ",
